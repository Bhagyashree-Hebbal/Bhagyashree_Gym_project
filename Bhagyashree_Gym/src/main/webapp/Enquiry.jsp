    ...
    <div class="enquiry-form-container">
        ...
        <form action="enquiry" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="area" name="area" class="form-control" placeholder="Enter your area" required>
            </div>

            <div class="mb-3">
                <label for="phone">Phone No</label>
                <input type="number" id="phone" name="phoneNo" class="form-control" placeholder="Enter your phone number" required>
            </div>

            <div class="mb-3">
                <label for="distance">Distance</label>
                <input type="text" id="distance" name="distance" class="form-control" placeholder="Enter distance" required>
            </div>
