...
<head>
    ...
    <style>
        ...
        /* Input field with margin for spacing */
        .form-control.me-2 {
            flex: 1;
            min-width: 200px;
        }

        /* Button styling for alignment and appearance */
        .btn-success {
            padding: 10px 15px;
            white-space: nowrap;
            font-size: 0.9rem;
            ...
            <form action="admin" method="get">
                ...
                <div class="mb-3">
                    ...
                    <div class="align-items-center">
                        <input type="email" id="email" name="email" class="form-control me-2" placeholder="Enter your Email" required>
                    </div>
                </div>
